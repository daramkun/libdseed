...
namespace dseed::media
{
	...
	DSEEDEXP dseed::error_t create_mf_media_encoder(dseed::io::stream* stream, const dseed::media::media_encoder_options* options, dseed::media::media_encoder** encoder);
}
