...
{
	dseed::f32x4x4_t worldTransform;
	dseed::f32x4x4_t projectionTransform;
};
...
public:
	virtual dseed::error_t clear_rendertarget(dseed::graphics::sprite_rendertarget* rendertarget, const dseed::f32x4_t& color) noexcept override;
...
public:
	virtual dseed::error_t begin(dseed::graphics::rendermethod method, const dseed::f32x4x4_t& transform) noexcept override;
