...
std::map<pctp, pcfn> g_pixelconvs = {
	...
	{ pctp(pixelformat::rgba8, pixelformat::ra8), pixelconv_plaincolor<rgba8, ra8> },
	{ pctp(pixelformat::rgba8, pixelformat::raf), pixelconv_plaincolor<rgba8, raf> },
	...
	{ pctp(pixelformat::rgb8, pixelformat::ra8), pixelconv_plaincolor<rgb8, ra8> },
	{ pctp(pixelformat::rgb8, pixelformat::raf), pixelconv_plaincolor<rgb8, raf> },
	...
	{ pctp(pixelformat::rgbaf, pixelformat::ra8), pixelconv_plaincolor<rgba8, ra8> },
	{ pctp(pixelformat::rgbaf, pixelformat::raf), pixelconv_plaincolor<rgba8, raf> },
	...
	{ pctp(pixelformat::bgra8, pixelformat::ra8), pixelconv_plaincolor<bgra8, ra8> },
	{ pctp(pixelformat::bgra8, pixelformat::raf), pixelconv_plaincolor<bgra8, raf> },
	...
	{ pctp(pixelformat::bgr8, pixelformat::ra8), pixelconv_plaincolor<bgr8, ra8> },
	{ pctp(pixelformat::bgr8, pixelformat::raf), pixelconv_plaincolor<bgr8, raf> },
	...
	{ pctp(pixelformat::bgra4, pixelformat::ra8), pixelconv_plaincolor<bgra4, ra8> },
	{ pctp(pixelformat::bgra4, pixelformat::raf), pixelconv_plaincolor<bgra4, raf> },
	...
	{ pctp(pixelformat::bgr565, pixelformat::ra8), pixelconv_plaincolor<bgr565, ra8> },
	{ pctp(pixelformat::bgr565, pixelformat::raf), pixelconv_plaincolor<bgr565, raf> },
	...
	{ pctp(pixelformat::r8, pixelformat::ra8), pixelconv_plaincolor<r8, ra8> },
	{ pctp(pixelformat::r8, pixelformat::raf), pixelconv_plaincolor<r8, raf> },
	...
	{ pctp(pixelformat::rf, pixelformat::ra8), pixelconv_plaincolor<rf, ra8> },
	{ pctp(pixelformat::rf, pixelformat::raf), pixelconv_plaincolor<rf, raf> },
	...
	{ pctp(pixelformat::ra8, pixelformat::rgba8), pixelconv_plaincolor<ra8, rgba8> },
	{ pctp(pixelformat::ra8, pixelformat::rgb8), pixelconv_plaincolor<ra8, rgb8> },
	{ pctp(pixelformat::ra8, pixelformat::rgbaf), pixelconv_plaincolor<ra8, rgbaf> },
	{ pctp(pixelformat::ra8, pixelformat::bgra8), pixelconv_plaincolor<ra8, bgra8> },
	{ pctp(pixelformat::ra8, pixelformat::bgr8), pixelconv_plaincolor<ra8, bgr8> },
	{ pctp(pixelformat::ra8, pixelformat::bgra4), pixelconv_plaincolor<ra8, bgra4> },
	{ pctp(pixelformat::ra8, pixelformat::bgr565), pixelconv_plaincolor<ra8, bgr565> },
	{ pctp(pixelformat::ra8, pixelformat::r8), pixelconv_plaincolor<ra8, r8> },
	{ pctp(pixelformat::ra8, pixelformat::rf), pixelconv_plaincolor<ra8, rf> },
	{ pctp(pixelformat::ra8, pixelformat::raf), pixelconv_plaincolor<ra8, raf> },
	{ pctp(pixelformat::ra8, pixelformat::yuva8), pixelconv_plaincolor<ra8, yuva8> },
	{ pctp(pixelformat::ra8, pixelformat::yuv8), pixelconv_plaincolor<ra8, yuv8> },
	{ pctp(pixelformat::ra8, pixelformat::hsva8), pixelconv_plaincolor<ra8, hsva8> },
	{ pctp(pixelformat::ra8, pixelformat::hsv8), pixelconv_plaincolor<ra8, hsv8> },

	{ pctp(pixelformat::raf, pixelformat::rgba8), pixelconv_plaincolor<raf, rgba8> },
	{ pctp(pixelformat::raf, pixelformat::rgb8), pixelconv_plaincolor<raf, rgb8> },
	{ pctp(pixelformat::raf, pixelformat::rgbaf), pixelconv_plaincolor<raf, rgbaf> },
	{ pctp(pixelformat::raf, pixelformat::bgra8), pixelconv_plaincolor<raf, bgra8> },
	{ pctp(pixelformat::raf, pixelformat::bgr8), pixelconv_plaincolor<raf, bgr8> },
	{ pctp(pixelformat::raf, pixelformat::bgra4), pixelconv_plaincolor<raf, bgra4> },
	{ pctp(pixelformat::raf, pixelformat::bgr565), pixelconv_plaincolor<raf, bgr565> },
	{ pctp(pixelformat::raf, pixelformat::r8), pixelconv_plaincolor<raf, r8> },
	{ pctp(pixelformat::raf, pixelformat::rf), pixelconv_plaincolor<raf, rf> },
	{ pctp(pixelformat::raf, pixelformat::ra8), pixelconv_plaincolor<raf, ra8> },
	{ pctp(pixelformat::raf, pixelformat::yuva8), pixelconv_plaincolor<raf, yuva8> },
	{ pctp(pixelformat::raf, pixelformat::yuv8), pixelconv_plaincolor<raf, yuv8> },
	{ pctp(pixelformat::raf, pixelformat::hsva8), pixelconv_plaincolor<raf, hsva8> },
	{ pctp(pixelformat::raf, pixelformat::hsv8), pixelconv_plaincolor<raf, hsv8> },
	...
	{ pctp(pixelformat::yuva8, pixelformat::ra8), pixelconv_plaincolor<yuva8, ra8> },
	{ pctp(pixelformat::yuva8, pixelformat::raf), pixelconv_plaincolor<yuva8, raf> },
	...
	{ pctp(pixelformat::yuv8, pixelformat::ra8), pixelconv_plaincolor<yuv8, ra8> },
	{ pctp(pixelformat::yuv8, pixelformat::raf), pixelconv_plaincolor<yuv8, raf> },
	...
	{ pctp(pixelformat::hsva8, pixelformat::ra8), pixelconv_plaincolor<hsva8, ra8> },
	{ pctp(pixelformat::hsva8, pixelformat::raf), pixelconv_plaincolor<hsva8, raf> },
	...
	{ pctp(pixelformat::hsv8, pixelformat::ra8), pixelconv_plaincolor<hsv8, ra8> },
	{ pctp(pixelformat::hsv8, pixelformat::raf), pixelconv_plaincolor<hsv8, raf> },
	...
	{ pctp(pixelformat::ra8, pixelformat::bgra8_indexed8), pixelconv_from_indexedcolor<ra8, bgra8> },
	{ pctp(pixelformat::raf, pixelformat::bgra8_indexed8), pixelconv_from_indexedcolor<raf, bgra8> },
	...
	{ pctp(pixelformat::ra8, pixelformat::bgr8_indexed8), pixelconv_from_indexedcolor<ra8, bgr8> },
	{ pctp(pixelformat::raf, pixelformat::bgr8_indexed8), pixelconv_from_indexedcolor<raf, bgr8> },
	...
	{ pctp(pixelformat::bgra8_indexed8, pixelformat::ra8), pixelconv_to_indexedcolor<bgra8, ra8> },
	{ pctp(pixelformat::bgra8_indexed8, pixelformat::raf), pixelconv_to_indexedcolor<bgra8, raf> },
	...
	{ pctp(pixelformat::bgr8_indexed8, pixelformat::ra8), pixelconv_to_indexedcolor<bgr8, ra8> },
	{ pctp(pixelformat::bgr8_indexed8, pixelformat::raf), pixelconv_to_indexedcolor<bgr8, raf> },
	...
	{ pctp(pixelformat::yuyv8, pixelformat::ra8), pixelconv_to_chromasubsample_yuv422<ra8> },
	{ pctp(pixelformat::yuyv8, pixelformat::raf), pixelconv_to_chromasubsample_yuv422<raf> },
	...
	{ pctp(pixelformat::nv12, pixelformat::ra8), pixelconv_to_chromasubsample_nv12<ra8> },
	{ pctp(pixelformat::nv12, pixelformat::raf), pixelconv_to_chromasubsample_nv12<raf> },
	...
	{ pctp(pixelformat::ra8, pixelformat::yuyv8), pixelconv_from_chromasubsample_yuv422<ra8> },
	{ pctp(pixelformat::raf, pixelformat::yuyv8), pixelconv_from_chromasubsample_yuv422<raf> },
	...
	{ pctp(pixelformat::ra8, pixelformat::nv12), pixelconv_from_chromasubsample_nv12<ra8> },
	{ pctp(pixelformat::raf, pixelformat::nv12), pixelconv_from_chromasubsample_nv12<raf> },
