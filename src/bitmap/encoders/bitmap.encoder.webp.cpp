...
class __webp_encoder : public dseed::bitmap_encoder
{
public:
	__webp_encoder (dseed::stream* stream, int quality, bool lossless)
...
dseed::error_t dseed::create_webp_bitmap_encoder (dseed::stream* stream, const dseed::bitmap_encoder_options* options, dseed::bitmap_encoder** encoder)
{
#if defined ( USE_WEBP ) && defined ( USE_BITMAP_ENCODERS )
