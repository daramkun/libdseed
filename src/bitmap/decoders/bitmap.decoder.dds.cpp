...
dseed::error_t dseed::create_dds_bitmap_decoder (dseed::stream* stream, dseed::bitmap_decoder** decoder)
{
	...
	if (header.ddspf.flags & DDS_RGB)
	{
		...
		case 32:
			if (header.ddspf.RBitMask == 0x000000ff && header.ddspf.GBitMask == 0x0000ff00 && header.ddspf.BBitMask == 0x00ff0000
				...
				format = dseed::pixelformat::grayscalef;
			else
				return dseed::error_not_support;
			break;
		...
		case 16:
			if (header.ddspf.RBitMask == 0x0f00 && header.ddspf.GBitMask == 0x00f0
				...
				format = dseed::pixelformat::bgra4444;
	...
	else if (header.ddspf.flags & DDS_YUV)
	{
		...
		case 32:
			if (header.ddspf.RBitMask == 0x000000ff && header.ddspf.GBitMask == 0x0000ff00 && header.ddspf.BBitMask == 0x00ff0000
				&& (header.ddspf.ABitMask == 0xff000000 || header.ddspf.ABitMask == 0))
				format = dseed::pixelformat::yuva8888;
			else if (header.ddspf.RBitMask == 0xffffffff && header.ddspf.GBitMask == header.ddspf.BBitMask == header.ddspf.ABitMask == 0)
				format = dseed::pixelformat::grayscalef;
			else
				return dseed::error_not_support;
	...
	else if (header.ddspf.flags & DDS_FOURCC)
	{
		if (!bc7HeaderLoaded)
		{
			...
			{
			case make_fourcc ('D', 'X', 'T', '1'): format = dseed::pixelformat::bc1; break;
			case make_fourcc ('D', 'X', 'T', '2'):
			case make_fourcc ('D', 'X', 'T', '3'): format = dseed::pixelformat::bc2; break;
			case make_fourcc ('D', 'X', 'T', '4'):
			case make_fourcc ('D', 'X', 'T', '5'): format = dseed::pixelformat::bc3; break;
			case make_fourcc ('B', 'C', '4', 'U'):
			case make_fourcc ('B', 'C', '4', 'S'):
			case make_fourcc ('A', 'T', 'I', '1'): format = dseed::pixelformat::bc4; break;
			case make_fourcc ('B', 'C', '5', 'U'):
			case make_fourcc ('B', 'C', '5', 'S'):
			case make_fourcc ('A', 'T', 'I', '2'): format = dseed::pixelformat::bc5; break;
			case make_fourcc ('P', 'T', 'C', '2'): format = dseed::pixelformat::pvrtc_2bpp; break;
			case make_fourcc ('P', 'T', 'C', '4'): format = dseed::pixelformat::pvrtc_4bpp; break;
			case make_fourcc ('E', 'T', 'C', ' '):
			case make_fourcc ('E', 'T', 'C', '1'): format = dseed::pixelformat::etc1; break;
			case 116: format = dseed::pixelformat::rgbaf; break;
			default:
				return dseed::error_not_support;
			}
		}
		else
		{
			...
			{
			case DXGI_FORMAT_BC6H_SF16: format = dseed::pixelformat::bc6h; break;
			case DXGI_FORMAT_BC7_UNORM: format = dseed::pixelformat::bc7; break;

			case DXGI_FORMAT_BC1_UNORM: format = dseed::pixelformat::bc1; break;
			case DXGI_FORMAT_BC2_UNORM: format = dseed::pixelformat::bc2; break;
			case DXGI_FORMAT_BC3_UNORM: format = dseed::pixelformat::bc3; break;
			case DXGI_FORMAT_BC4_UNORM: format = dseed::pixelformat::bc4; break;
			case DXGI_FORMAT_BC5_UNORM: format = dseed::pixelformat::bc5; break;

			case DXGI_FORMAT_R8G8B8A8_UNORM: format = dseed::pixelformat::rgba8888; break;
			case DXGI_FORMAT_B8G8R8A8_UNORM: format = dseed::pixelformat::bgra8888; break;
			case DXGI_FORMAT_B4G4R4A4_UNORM: format = dseed::pixelformat::bgra4444; break;

			case DXGI_FORMAT_AYUV: format = dseed::pixelformat::yuva8888; break;
			case DXGI_FORMAT_YUY2: format = dseed::pixelformat::yuyv8888; break;
			case DXGI_FORMAT_NV12: format = dseed::pixelformat::nv12; break;

			case DXGI_FORMAT_R8_UNORM: format = dseed::pixelformat::grayscale8; break;
			case DXGI_FORMAT_R32_FLOAT: format = dseed::pixelformat::grayscalef; break;

			case DXGI_FORMAT_ASTC_4X4_UNORM: format = dseed::pixelformat::astc_4x4; break;
			case DXGI_FORMAT_ASTC_5X4_UNORM: format = dseed::pixelformat::astc_5x4; break;
			case DXGI_FORMAT_ASTC_5X5_UNORM: format = dseed::pixelformat::astc_5x5; break;
			case DXGI_FORMAT_ASTC_6X5_UNORM: format = dseed::pixelformat::astc_6x5; break;
			case DXGI_FORMAT_ASTC_6X6_UNORM: format = dseed::pixelformat::astc_6x6; break;
			case DXGI_FORMAT_ASTC_8X5_UNORM: format = dseed::pixelformat::astc_8x5; break;
			case DXGI_FORMAT_ASTC_8X6_UNORM: format = dseed::pixelformat::astc_8x6; break;
			case DXGI_FORMAT_ASTC_8X8_UNORM: format = dseed::pixelformat::astc_8x8; break;
			case DXGI_FORMAT_ASTC_10X5_UNORM: format = dseed::pixelformat::astc_10x5; break;
			case DXGI_FORMAT_ASTC_10X6_UNORM: format = dseed::pixelformat::astc_10x6; break;
			case DXGI_FORMAT_ASTC_10X8_UNORM: format = dseed::pixelformat::astc_10x8; break;
			case DXGI_FORMAT_ASTC_10X10_UNORM: format = dseed::pixelformat::astc_10x10; break;
			case DXGI_FORMAT_ASTC_12X10_UNORM: format = dseed::pixelformat::astc_12x10; break;
			case DXGI_FORMAT_ASTC_12X12_UNORM: format = dseed::pixelformat::astc_12x12; break;
